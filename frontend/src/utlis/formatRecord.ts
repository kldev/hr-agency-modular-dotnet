...
/** One answer to "how is an address written here", for the places that show one. */
...
/** A period, with the dash standing in for "open-ended". Projects, assignments and permits. */
