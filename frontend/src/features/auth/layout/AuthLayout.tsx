			...
			<section className="auth-visual" aria-hidden="true">
				...
				<div className="auth-visual-content">
					...
					<div className="auth-visual-copy">
						...
						<p>
							Manage candidates, companies, job posts and interviews from one professional
							workspace.
						</p>
					</div>
					...
					<div className="auth-visual-features">
						<div className="auth-visual-feature">
							...
							<span>
								...
								<small>Keep your recruitment pipeline organized.</small>
							</span>
						</div>
						...
						<div className="auth-visual-feature">
							...
							<span>
								...
								<small>Your agency data stays protected.</small>
							</span>
						</div>
					</div>
				</div>
