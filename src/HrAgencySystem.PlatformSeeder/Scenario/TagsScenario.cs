...
internal sealed class TagsScenario(IMessageBus bus, IDocumentSession session)
{
    ...
    {
        IEnumerable<string> postTitles = ["C# Developer", "NextJS Developer", "NodeJS Developer", "Java Backend Entwickler", "ava Backend Developer"];
    ...
    private async Task TagApplicant(Guid applicantId, Guid organizationId, IReadOnlyList<Tag> tags,
