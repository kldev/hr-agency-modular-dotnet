...
{
    public static ContactPerson Create(IContactData data)
    {
    ...
    public static ContactPersonValueObject CreateValueObjects(IContactData data)
    {
        var errors = new List<string>();
        ...
        return new ContactPersonValueObject(email!, firstName!, lastName!, jobTitle!, phone!);
    }
}
