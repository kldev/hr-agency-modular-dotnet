...
internal static class MapRemoveTagList
{
    internal static void Map(RouteGroupBuilder group)
    {
        ...
        group.MapPut("{candidateId:guid}/tag/remove", Handler)
        ...
        CancellationToken ct)
    {
        ...
        {
             result =
                await bus.InvokeAsync<CandidateTagRemoved>(
                    new RemoveCandidateTag(candidateId, tag, user.OrganizationId, user.UserId), ct);
