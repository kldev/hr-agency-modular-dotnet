...
internal static class MapTagList
{
    internal static void Map(RouteGroupBuilder group)
    {
        ...
        group
            .MapPut(ApiEndpoints.Recruitment.Candidates.TagList, Handler)
    ...
    )
    {
        ...
        {
            result = await bus.InvokeAsync<CandidateTagged>(
                new TagCandidate(tag, candidateId, user.OrganizationId, user.UserId),
                ct
            );
        }
