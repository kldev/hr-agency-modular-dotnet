...
internal static class MapRemoveTagList
{
    internal static void Map(RouteGroupBuilder group)
    {
        ...
        group.MapPut("{applicationId:guid}/tag/remove", Handler)
        ...
        CancellationToken ct)
    {
        ...
        {
            result =
                await bus.InvokeAsync<JobApplicationTagRemoved>(
                    new RemoveApplicationTag(applicationId, tag, user.OrganizationId, user.UserId), ct);
