...
internal static class MapTag
{
    internal static void Map(RouteGroupBuilder group)
    {
        ...
        group
            .MapPut(ApiEndpoints.Recruitment.JobApplications.Tag, Handler)
    ...
    {
        var result = await bus.InvokeAsync<JobApplicationTagged>(
            new TagApplication(request.TagId, applicationId, user.OrganizationId, user.UserId),
            ct
        );
