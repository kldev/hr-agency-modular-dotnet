...
public partial class StatusChangeHistoryProjection : EventProjection
{
    ...
    public JdStatusChangeHistory Create(IEvent<JobDescriptionCreated> @event) =>
        new()
        {
    ...
    public async Task Project(
        IEvent<JobDescriptionOpened> @event,
    ...
    )
    {
        ...
        var timeInPreviousStatus = changedAt - document.CurrentStatusStartedAt;

        document.Changes.Add(
            new StatusChange(document.CurrentStatus, newStatus, changedAt, timeInPreviousStatus)
        );
        ...
        operations
            .Patch<JdStatusChangeHistory>(jobDescriptionId)
            .Set(z => z.Changes, document.Changes);
        operations
            .Patch<JdStatusChangeHistory>(jobDescriptionId)
            .Set(z => z.CurrentStatus, newStatus);
        operations
            .Patch<JdStatusChangeHistory>(jobDescriptionId)
            .Set(z => z.CurrentStatusStartedAt, changedAt);
    }
}
