...
{
    internal static IQueryable<JobDescriptionProjection> WithOrganizationId(
        this IQueryable<JobDescriptionProjection> query,
        Guid organizationId
    )
    {
    ...
    internal static IQueryable<JobDescriptionProjection> WithCompanyId(
        this IQueryable<JobDescriptionProjection> query,
        Guid? companyId
    )
    {
    ...
    internal static IQueryable<JobDescriptionProjection> WithStatuses(
        this IQueryable<JobDescriptionProjection> query,
    ...
    internal static IQueryable<JobDescriptionProjection> WithJobDescriptionId(
        this IQueryable<JobDescriptionProjection> query,
