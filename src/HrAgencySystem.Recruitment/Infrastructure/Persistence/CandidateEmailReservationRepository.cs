...
public sealed class CandidateEmailReservationRepository(IDocumentSession session)
    : ICandidateEmailReservationRepository
{
    ...
    )
    {
        return await session
            .Query<CandidateEmailReservation>()
    ...
    {
        var reservation = new CandidateEmailReservation(
            Guid.NewGuid(),
