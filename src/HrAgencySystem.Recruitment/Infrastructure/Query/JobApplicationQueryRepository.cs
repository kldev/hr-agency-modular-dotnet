...
public sealed class JobApplicationQueryRepository(IQuerySession session)
    : IJobApplicationQueryRepository
{
    public async Task<SliceResponse<JobApplicationProjection>> GetJobApplications(
        Guid organizationId,
    ...
    public async Task<JobApplicationProjection?> GetJobApplication(
        Guid organizationId,
