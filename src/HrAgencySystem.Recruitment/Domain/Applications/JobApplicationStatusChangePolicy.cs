...
{
    public static bool Allow(JobApplicationStatus currentStatus, JobApplicationStatus newStatus)
    {
        if (currentStatus == newStatus)
            return false;

        if (
            newStatus is JobApplicationStatus.Rejected or JobApplicationStatus.Withdrawn
